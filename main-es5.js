    ...
    function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function getUser(userInfo) {
          ...
          this.http.post('http://localhost:3000/api/login', userInfo).subscribe(function (data) {
    ...
    function () {
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function addUser(userInfo) {
          ...
          this.http.post('http://localhost:3000/api/register', userInfo).subscribe(function (data) {
